...
public class UsuarioControle {
    ...
    public ResponseEntity<?> adicionar(@RequestBody GaleriaModelo gm, @PathVariable Long usuario_id){
        return us.adicionarImagem(gm);
    }
    ...
    @GetMapping("/galeria")
    public Iterable<?> visuailizarImagem(@RequestParam(name = "imagem_id") Long imagem_id ){
        return us.listarImagem(imagem_id);
    }
    
    @GetMapping("u/{usuario_id}/galeria/pesquisa")
    public Iterable pesquisaImagens(@PathVariable Long usuario_id, @RequestParam(name="pesquisa") String pesquisa){
        return us.pesquisarImagens(pesquisa, usuario_id);
    }
    
    @PutMapping("/u/{usuario_id}/galeria")
    public void alterar_favorito(@PathVariable Long usuario_id, @RequestBody GaleriaModelo gm){
         us.favorito(gm);
    }
    
    @GetMapping("/u/{usuario_id}/galeria/favoritos")
    public ResponseEntity<?> mostarFavoritos(@PathVariable Long usuario_id){
        return us.mostrarFavoritos(usuario_id);
    }
    
    @DeleteMapping("/u/{usuario_id}/galeria")
    public void deletarImagem(@PathVariable Long usuario_id, @RequestParam(name = "imagem_id") Long imagem_id){
        us.deletarImagem(imagem_id);
    }
